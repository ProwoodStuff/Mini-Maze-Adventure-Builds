 ...
 rem score = score + 1
  rem const noscore = 1
   rem const pfscore = 1
    rem pfscore1 = %00010101
     rem pfscorecolor = $2A
     rem pfscore1 = pfscore1/4
...
mainloop
 ...
 rem if collision(player0, playfield) then player0x = PrevX
 rem if collision(player0, playfield) then player0y = PrevY
